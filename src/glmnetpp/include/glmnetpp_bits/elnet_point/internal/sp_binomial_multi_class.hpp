...
public:
    ...
    GLMNETPP_STRONG_INLINE
    void update_beta(index_t k, index_t i, const PointPackType& pack) {
        base_t::update_beta(k, i, sp_base_t::compute_grad(k, this->resid(), this->new_weight()), pack.l1_regul(), pack.l2_regul());
    }
